...
/* -----------------------------------------------------------------------------
 * Created by Ulysses on 08/23/2019
 *
 * Problem07_05.cpp
 * Modify Token_stream::get() to return Token(print) when it sees a new-
...
Token Token_stream::get(){
    ...
    case '\\':{
        ...
        if (s == str_newline) return Token(print);
        else error(s + ": Invalid Control.");
