...
/* -----------------------------------------------------------------------------
 * For the next few examples, the code in each program is intended to replace
 * a section of Calculator02.cpp. To test it, please just copy-paste the new
 * section onto Calc02_Test.cpp.
 * 
...
/* -----------------------------------------------------------------------------
 * Grammar Details: ADDED {} TO PRIMARY. PLEASE TEST PRIMARY.
...
// Replacement code is as follows:
double primary(){
    Token t = ts.get();
    switch (t.kind) {
...
void version(){
	puts("Problem6_02: Added {} to primary.");
}	
// Imported code from Calc02_Test.cpp
//------------------------------------------------------------------------------
